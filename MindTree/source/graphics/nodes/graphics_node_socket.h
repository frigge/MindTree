...
class SocketViewButton : public QGraphicsItem
{
public:
    SocketViewButton(VNSocket *socket);
    virtual ~SocketViewButton();
...
class VNASocket : public VNSocket
{
public:
    VNASocket(DAInSocket *, VNode*);
    virtual ~VNASocket();
